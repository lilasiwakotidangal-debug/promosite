...
import studioPrintsImage from "../files/studioprints.png";
...
const selectedWorks = [
  ...
  { image: galleryImageFive, alt: "Studio output detail", className: "" },
];
    ...
    <main className="page homePage">
      ...
      <section className="homeOfferings">
        ...
        <div className="homeOfferingGrid">
          {offerings.map((item) => (
            <article className="homeOfferingCard" key={item.title}>
              <div className="homeOfferingImageWrap">
                <Image src={item.image} alt={item.title} className="homeOfferingImage" />
              </div>
